...
img = img_as_float(io.imread("D:/DS_python/Python-for-microscopists/images/Alloy_noisy.jpg"))
...
plt.imsave("D:/DS_python/Python-for-microscopists/images/markers.jpg", markers)
segm1 = (labels == 1)
segm2 = (labels == 2)
...
plt.imsave("D:/DS_python/Python-for-microscopists/images/random_walker.jpg", all_segments_cleaned)
