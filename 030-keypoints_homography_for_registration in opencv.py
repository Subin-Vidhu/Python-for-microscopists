...
im1 = cv2.imread('D:/DS_python/Python-for-microscopists/images/monkey_distorted.jpg')          # Image that needs to be registered.
im2 = cv2.imread('D:/DS_python/Python-for-microscopists/images/monkey.jpg') # trainImage
